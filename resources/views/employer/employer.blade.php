                            ...
                            <div
                                ...
                                <div class="u-container-layout u-container-layout-1">
                                    <div class="u-expanded-width u-form u-form-1 mb-5">
                                        <form action="{{ route('employers.show') }}" method="GET" id="search-form"
                                    ...
                                    <div class="custom-expanded u-form u-form-2">
                                        <form action="{{ route('employers.show') }}" method="GET" id="location-form"
                                    ...
                                    <div class="custom-expanded u-form u-form-3">
                                        <form action="{{ route('employers.show') }}" method="GET" id="category-form"
                                              class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form"
                                              source="email" name="form-1" style="padding: 10px;">
                                ...
                                <div class="u-container-style u-layout-cell u-size-44 u-layout-cell-2">
                                    <div class="u-container-layout u-container-layout-2">
                                        <p class="u-text u-text-default u-text-10">Showing 1 – 10
                                            ...
                                            of {{ $employers->total() > 0 ? $employers->total() : 0 }}
                                            results </p>
                                        <div class="u-form u-form-10">
                                            <form action="{{ route('employers.show') }}" method="GET"
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="{{route('employer.details',$employer->id)}}"
                                                                       class="text-black u-border-hover-grey-15">
                                                                        <h6 class="u-text u-text-default u-text-11"> {{$employer->company_name}}
                                                                            &nbsp;
                                                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                            &nbsp;
                                                                            &nbsp;
